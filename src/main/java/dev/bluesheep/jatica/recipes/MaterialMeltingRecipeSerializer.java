...
public class MaterialMeltingRecipeSerializer implements IRecipeSerializer {
    ...
    public JsonElement get() {
        ...
        root.addProperty("input", "jatica:" + material.getName());
        root.addProperty("temperature", Mth.clamp(fluidSupplier.get().getFluidType().getTemperature() - 300, 0, Integer.MAX_VALUE));
        root.add("result", fluidIngredient);
