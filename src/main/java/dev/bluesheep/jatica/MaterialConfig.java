...
public class MaterialConfig {
    ...
    public MaterialConfig(IDynamicSpecConfig config) {
        ...
        List<Supplier<?>> allConfigs = List.of(
                materialCraftable,
                materialCastable,
                materialMeltable,
                materialTier,
                ...
                bowstringEnabled,
                bowstringTraits,
                platingHelmetEnabled,
                platingChestplateEnabled,
                platingLeggingsEnabled,
                platingBootsEnabled,
                platingShieldEnabled,
                platingHelmetArmor,
                platingChestplateArmor,
                platingLeggingsArmor,
                platingBootsArmor,
                platingDurabilityFactor,
                platingToughness,
                platingKnockbackResistance,
                platingTraitsHelmet,
                platingTraitsChestplate,
                platingTraitsLeggings,
                platingTraitsBoots,
                platingTraitsShield,
                mailleEnabled,
                mailleTraits,
